...
<body>
 ...
 <h1 id="h1"> Velas e Sabontes Artesanais</h1><br>
  ...
  <div class="coluna3">
    <h2 id="h2">Vela Aromática<p><p></p>
   
    Ajuda a criar um clima agradável, relaxante e promove bem-estar. 
    Ensinamos todos os passos de como usar em casa
     e aproveitar ao máximo todas as vantagens desse objeto desejado do momento!<br>
...
<div class="linha">
  <div class="coluna3" >
    <h2 id="h2">Vela aromática x Vela comum<p></p>

    As velas comuns não possuem aroma, já as velas aromáticas, os aromas fazem parte da composição 
    e ajudam a transmitir sensações de bem-estar </h2>
    <a class="a" href="./produto.html" style="width: 100%; margin-left: 70%;">
      Ver Mais <img src="../img/seta.png" style="width:5% ;"></a>
  </div>
  <div class="coluna3" style="background-color:#fcdcee;" >
...
<br>
        <div class="linha"style="background-color: #fcdcee; box-shadow: 0 -10px 10px -10px rgba(0, 0, 0, 0.5)">
          <h2 style="margin-left: 9%;"><br>Como usar a vela aromática de forma correta?</h2></div>
          
          <div class="linha"style="background-color: #fcdcee; box-shadow: 0 10px 10px -10px rgba(0, 0, 0, 0.5);">
            <div class="coluna">
          <p style="margin-left: 9%;">A vela aromática precisa de cuidados especiais para exalar o aroma de forma correta, 
            o primeiro passo é deixar a vela acesa durante 30 minutos, o pavio apagado deve ter no mínimo 4mm de altura, se a chama estiver muito alta, acima de 2cm, 
            corte o pavio antes de acender a vela. Nunca deixe sua vela queimando por mais de 4 horas seguidas, e sempre com a supervisão de um adulto! Não toque na cera enquanto a vela estiver acesa. 
            Não utilize mais a vela quando tiver ¼ de cera no fundo.
        </div>
  ...
  <h2>Benefícios dos sabonetes Lumière</h2></div><br>
    <div class="container">
    <div class="owl-carousel owl-theme">
        <div class="item">
          <div class="card" style="width: 18rem;" id="borda">
            ...
            <div class="card-body">
              <p class="card-text">A essência de frutas silvestres proporciona 
                relaxamento e energização. O aroma favorece a lucidez de ideias produzindo um ambiente afrodisíaco suave.</p>
              <br>
            </div>
        </div>
        </div> <br>
